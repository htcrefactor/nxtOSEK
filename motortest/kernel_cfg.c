/*
 *  kernel_cfg.c
 *  Mon Sep 21 15:56:59 2020
 *  SG Version 2.00
 *  sg.exe ./motortest.oil -os=ECC2 -I /home/osek/nxtOSEK/toppers_osek/sg/impl_oil -template=/home/osek/nxtOSEK/toppers_osek/sg/lego_nxt.sgt
 */
...
const FP tinib_task[TNUM_TASK] = { TASKNAME( Task1 ), TASKNAME( Task2 ), };
const __STK_UNIT tinib_stk[TNUM_TASK] = { (__STK_UNIT)_stack_Task1, (__STK_UNIT)_stack_Task2, };
...
const FP alminib_cback[TNUM_ALARM] = { _activate_alarm_al_100ms, };
