/*
 *  kernel_cfg.c
 *  Mon Sep 21 17:05:33 2020
 *  SG Version 2.00
 *  sg ./motortest.oil -os=ECC2 -I/home/osek/nxtOSEK/ecrobot/../toppers_osek/sg/impl_oil -template=/home/osek/nxtOSEK/ecrobot/../toppers_osek/sg/lego_nxt.sgt
 */
...
static __STK_UNIT _stack_Task3[__TCOUNT_STK_UNIT(512)];
...
const FP tinib_task[TNUM_TASK] = { TASKNAME( Task1 ), TASKNAME( Task2 ), TASKNAME( Task3 ), };
const __STK_UNIT tinib_stk[TNUM_TASK] = { (__STK_UNIT)_stack_Task1, (__STK_UNIT)_stack_Task2, (__STK_UNIT)_stack_Task3, };
...
const AlarmType al_100ms = 0;
const AlarmType al_100ms_1 = 1;
const AlarmType al_200ms_1 = 2;

DeclareTask(Task1);
static void _activate_alarm_al_100ms( void );
static void _activate_alarm_al_100ms( void )
{ (void)ActivateTask( Task1 ); }

DeclareTask(Task2);
static void _activate_alarm_al_100ms_1( void );
static void _activate_alarm_al_100ms_1( void )
{ (void)ActivateTask( Task2 ); }

DeclareTask(Task3);
static void _activate_alarm_al_200ms_1( void );
static void _activate_alarm_al_200ms_1( void )
{ (void)ActivateTask( Task3 ); }

const CounterType alminib_cntid[TNUM_ALARM] = { 0, 0, 0, };
const FP alminib_cback[TNUM_ALARM] = { _activate_alarm_al_100ms, _activate_alarm_al_100ms_1, _activate_alarm_al_200ms_1, };
...
const TickType alminib_cycle[TNUM_ALARM] = { 100, 100, 100, };
