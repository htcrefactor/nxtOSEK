/*
 *  kernel_cfg.c
 *  Wed Sep 23 14:07:25 2020
 *  SG Version 2.00
 *  sg ./eventtest.oil -os=ECC2 -I/home/osek/nxtOSEK/ecrobot/../toppers_osek/sg/impl_oil -template=/home/osek/nxtOSEK/ecrobot/../toppers_osek/sg/lego_nxt.sgt
 */
...
const TaskType Task2 = 0;
const TaskType Task1 = 1;
...
const FP tinib_task[TNUM_TASK] = { TASKNAME( Task2 ), TASKNAME( Task1 ), };
const __STK_UNIT tinib_stk[TNUM_TASK] = { (__STK_UNIT)_stack_Task2, (__STK_UNIT)_stack_Task1, };
...
const AlarmType al_50ms = 0;

DeclareTask(Task1);
static void _activate_alarm_al_50ms( void );
static void _activate_alarm_al_50ms( void )
{ (void)ActivateTask( Task1 ); }

const CounterType alminib_cntid[TNUM_ALARM] = { 0, };
const FP alminib_cback[TNUM_ALARM] = { _activate_alarm_al_50ms, };
...
const EventMaskType event1 = (1UL << 0);
